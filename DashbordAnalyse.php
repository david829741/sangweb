            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
                  ...
                  <div class="dropdown-divider"></div>
                  <p class="p-3 mb-0 text-center2">...</p>
                </div>
              </li>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">                                  
                        <h2 class="mb-0" id="nombreDeCentres2">...</h2>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    echo'<div class="badge btn-inverse-success
                         "><a href="pages/forms/adddonneur.php?id='.$id_centre.'">Nouveau<a></div>';
                    ?>
...
$date_jour = date('Y-m-d');
    ...
    <script src="pages/forms/Api-Autoactualisation/js/centre2.js"></script>
    <script src="pages/forms/Api-Autoactualisation/js/effectifs2.js"></script>
    <script src="pages/forms/Api-Autoactualisation/js/Potentiels2.js"></script>
    <script src="pages/forms/Api-Autoactualisation/js/participant2.js"></script>
    <script src="pages/forms/Api-Autoactualisation/js/desistements2.js"></script>
    <script src="pages/forms/Api-Autoactualisation/js/aujourd2.js"></script>
