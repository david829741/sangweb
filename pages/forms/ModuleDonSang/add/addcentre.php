      ...
      if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `centre` (denomination, localisation, nbr_max) VALUES (?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssi", $denomination, $localisation, $nbr_max);
        $stmt->execute();
        $stmt->close();
			            ...
			            <div class="content-wrapper">
			              ...
			              <div class="row">
			                ...
			                <div class="col-12 grid-margin stretch-card">
			                  <div class="card">
			                    <div class="card-body">
			                      <div class="form-group">
			                        <label for="exampleInputUsername1">Centre</label>
			                        <input name="denomination" type="text" class="form-control" id="exampleInputUsername1">
			                      </div>
			                      <div class="form-group">
			                        <label for="exampleInputUsername1">Localisation</label>
			                        <input name="localisation" type="text" class="form-control" id="exampleInputUsername1">
			                      </div>

			                      <div class="form-group">
			                        <label for="exampleInputPassword1">Capaciter de prélévement par jour </label>
			                        <input name="nbr_max" type="text" class="form-control" id="exampleInputPassword1">
			                      </div>
			                      <div class="form-group">
                              ...
                              <?php
                                $sql = "SELECT id, type FROM `region`";
                                $stmt = $conn->prepare($sql);
                                $stmt->execute();
                                ...
                                if ($result) {
                                  ...
                                  die("Could not connect to the database because: " . $stmt->error);
                                }
                                ?>
			                        </select>
			                      </div>
			                      <div class="form-group">
			                        ...
			                        <select class="form-control" id="exampleSelectGender" name='idcentre'>
			                          <?php
																													  $sql = "SELECT id, denomination FROM `centre`";
																													  $stmt = $conn->prepare($sql);
																													  $stmt->execute();
																													  $result = $stmt->get_result();
