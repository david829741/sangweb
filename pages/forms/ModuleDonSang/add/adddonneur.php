      ...
      if (isset($_POST['submit'])) {
        ...
        $int=3;
          $stmtPrelever->bind_param("iiis", $id_centre, $lastDonneurId, $int, $dateParam);
			          ...
			          <div class="row">
			            <div class="col-12 grid-margin stretch-card">
			              <div class="card corona-gradient-card">
                            ...
                            if ($ajout == 1) {
                              echo '  <p class="mb-0 font-weight-normal d-none d-sm-block">Insertion réussie.</p>
<img src="RECHERCHE/approuve.png" alt=""  width="50"> ';
                            } else if ($ajout == 2) {
                              echo '  <p class="mb-0 font-weight-normal d-none d-sm-block">Erreur lors de l"insertion</p>
  <img src="RECHERCHE/close.png" alt=""  width="50">';
                            ...
                            ?>
			                    ...
			                    <div class="col-3 col-sm-2 col-xl-2 pl-0 text-center">
			                      <span>
			                        <a href="<?php $param = "dashbordccentre.php";
